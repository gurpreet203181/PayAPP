        ...
        <View>
            <Modal isVisible={isVisible}
             ...
             style={styles.view} >
              ...
              <View style={{height:500, backgroundColor:COLORS.white, borderTopStartRadius:30, borderTopEndRadius:30}}>
                 
                  <View  style={{...SIZES.marginHorizontal, marginTop:20 }}>
                   <Text style={{...FONTS.h4,fontSize:14}}>{t('Filter')}</Text>
                  </View>
               
                <ScrollView style={{...SIZES.marginHorizontal, marginTop:20 }} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{flex:1}} onStartShouldSetResponder={() => true}>
                       ...
                       <CustomMultiSlider min={0} max={1000} defaultValue={[0,500]} onValuesChange={setMultiSliderValue}/>
                       ...
                       <Button label={t('apply')} onPress={() => {filters(appliedFilters)}}/>
                   </View>
