...
const PaymentSuccess = ({navigation}) => {
    ...
    return(
        <View style={{flex:1, backgroundColor:COLORS.white, alignItems:'center'}}>
            ...
            <View style={{flex:0.8, justifyContent:'center', alignItems:'center', ...SIZES.marginHorizontal}}>
             {renderLottieNfc()}
             <Text style={styles.successText}>{t('paymentSuccess')}</Text>
             <Text adjustsFontSizeToFit numberOfLines={2} style={styles.successText2}>{t('paymentInfoText')}</Text>
