const it = {
  ...
  authLayout_TitleForgotPass: "Hai dimenticato la password?",
  authLayout_ForgotPass_SubTitle:
  ...
  addCardSubTitle:
    "Inizia a digitare per aggiungere i dettagli della tua carta di credito.",
  number: "Numero",
  expiryDate: "Scadenza",
  cvv: "CVV",
  save: "salva",
  ...
  details: "Dettagli",
  itemDetail:
    "Articolo {{item}} acquistato il {{date}} con numero di carta {{card}}",
  ...
  procced: "Procedere",
  paymentInfoText:
    "invieremo i dettagli dell'ordine e la fattura al tuo numero di contatto. ed e-mail registrata",
  ...
  noBalance:
    "Il tuo saldo è vuoto, deposita denaro per trasferire senza commissioni e dire",
  depositNow: "Deposita ora",

  //Transfer
  transferMoney: "Trasferire denaro",
  continue: "CONTINUA",
  ...
  selectCard: "Seleziona una carta",
  selectCardText:
    "Per favore, seleziona una carta con cui sei disposto a fare il trasferimento di denaro o aggiungi una nuova carta.",
  ...
  billPayment: "Pagamento delle bollette",
  withdraw: "Ritirare",
  otherMenu: "Altro Menu  ",
  historyTransactions: "Transazioni storiche",
